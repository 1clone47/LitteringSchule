  ...
  <div class="bg-gradient-to-r from-blue-300 via-blue-500 to-blue-300 items-center w-auto h-auto">
    <div class="flex flex-col text-center mt-4 mx-2 rounded-md space-y-4">
      ...
      <div class="flex flex-row space-x-4 border-4 rounded-md border-white bg-white items-center justify-center text-center">
        ...
        <div class="text-left">
          <p class="xl:text-3xl xs:text-xs">Es gibt verschiedene Maßnahmen, die ergriffen werden können, um Littering zu verhindern und zu reduzieren. Einige mögliche Maßnahmen sind</p>
        </div>
      </div>
      <div class="flex flex-row w-auto h-auto space-x-4">
        <div class="flex-1 flex flex-col border-4 items-center justify-center text-center border-white bg-white rounded-md xl:text-2xl xs:text-xs">
          ...
          <p>
            Es können Kampagnen durchgeführt werden, um das Bewusstsein der Öffentlichkeit für die Auswirkungen von Littering zu erhöhen und das richtige Entsorgen von Abfällen zu fördern.
          </p>
        </div>
