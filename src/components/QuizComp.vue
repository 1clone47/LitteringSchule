...
<template>
  <div class="w-auto h-auto bg-gradient-to-r from-blue-300 via-blue-500 to-blue-300 items-center space-y-4">
    ...
    <div class="flex flex-row space-x-4 mx-32 xs:mx-2 border-4 rounded-md border-white bg-white items-center justify-center text-center">
    ...
    <div v-if="showResult" class="w-auto text-center items-center flex flex-col text-white space-y-4">
