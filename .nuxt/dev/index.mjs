...
import { provider, isWindows } from 'file:///Users/andy/code/web/LitteringSchule/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/andy/code/web/LitteringSchule/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/andy/code/web/LitteringSchule/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/andy/code/web/LitteringSchule/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/andy/code/web/LitteringSchule/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/andy/code/web/LitteringSchule/node_modules/ofetch/dist/node.mjs';
...
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/andy/code/web/LitteringSchule/node_modules/ufo/dist/index.mjs';
...
const getClientManifest = () => import('/Users/andy/code/web/LitteringSchule/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/andy/code/web/LitteringSchule/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
